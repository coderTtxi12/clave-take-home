...
This module handles extraction and processing of images generated by the
code executor. When Python code generates charts (e.g., using Matplotlib),
the code executor outputs "IMAGE: path/to/image.png" markers.

This module:
1. Extracts IMAGE: markers from execution results
2. Converts image files to base64 for API responses
3. Embeds images in Markdown responses
4. Handles errors gracefully (missing files, conversion failures)
